...
having a *hot hand*. In this lab we'll apply one approach to answering questions 
like this. The goals for this lab are to <div>
(1) think about the effects of independent and dependent events
(2) learn how to simulate shooting streaks in R
(3) to compare a simulation to actual data in order to determine if the hot hand 
...
## Simulations in R with Independent Shooter
 ...
 *This answer because the independent shooter DOESNT have hot hands where consecutive shots means higher probability. If the
 Independent shooter's distribution was different than Kobe's spread, then we can say Kobe might have hot hands. *
