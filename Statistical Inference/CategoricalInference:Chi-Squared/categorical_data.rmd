...
sum((atheism$response=="atheist")/length(atheism$response))
```
...
inference(y = response, data = es, statistic = "proportion", type = "ht", null=0,
...
```{r us-05-12}
us_data <- subset(atheism, atheism$nationality == "United States")
inference(y = response, data = us_data, statistic = "proportion", type = "ht", null=0,
          alternative="twosided", method = "theoretical", success = "atheist")
